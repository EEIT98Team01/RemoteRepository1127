...
public class ClassficationService {
	...
	// 回傳符合某條件的資料
	@Transactional(readOnly = true)
	public List<ClassficationBean> findByCondition(String classficationID, String classficatoinName) {
		if((classficationID == null) && (classficatoinName == null)){
			return classficationDao.find();//未使用任何條件
		}else{
			Map<String,String> condition = new HashMap<String,String>();
			if(classficatoinName != null){
				condition.put("classficatoinName", "=" + classficatoinName);
			}
