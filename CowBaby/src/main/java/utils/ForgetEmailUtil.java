...
public class ForgetEmailUtil {
	...
	public static void main(String[] args) {
		 String result = ForgetEmailUtil.sendEmail("s730530@gmail.com", "123456",
		 "<h1>CowBaby</h1><br><a href='http://yahoo.com.tw'>雅虎奇摩<a/>",null);
//		System.out.println(EmailUtil.emailAddressAutoAdjustLength("x120445166@yahoo.com.tw"));
	...
	public static String sendEmail(String receiver, String subject, String htmlMessage, String imagePath) {
		...
		try {
			...
			message.addRecipient(Message.RecipientType.TO, new InternetAddress(ForgetEmailUtil.emailAddressAutoAdjustLength(receiver)));
			transport.connect();
