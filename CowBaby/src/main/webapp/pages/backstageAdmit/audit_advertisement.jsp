     	...
     	<section id="main-content">
			<section class="wrapper" id="audit_advertisement">
				...
				<div class="row">	
					<div class="col-md-12">
						<div class="panel">	
							<table class="table table-striped table-bordered" id="audit_advertisment_List"> 
	 	...
	 	$.ajax({
	       ...
	       dataType:"json",   
	       	...
	       	beforeSend: function(){
		       	...
		       	$("#audit_advertisment_List").LoadingOverlay("show");
			}, 
		...
		// 成功要做的事
	       success : function(response){   
	          ...
	          $.each(obj, function (index, customer) {
				...
				// loading hide
				setTimeout(function(){
		       		$("#audit_advertisment_List").LoadingOverlay("hide");
		       	},300)	
	       },
