		        ...
		        success : function(response){   
			        ...
			        $.each(obj, function (index, myitem) {
			        	   console.log("customer",myitem);
			           	    var html="";
			 		    	html="<div class='item'>"+                                                                                        
		 							"<a href='<c:url value='CustomerManagementView.controller'/>?storeID=" + myitem.customerID + "&productID=" + myitem.productID + ">"+
			 							"<img src='<c:url value='/images/newArrived1.jpg'/>'>"+
			 							"<p class='stroe_name'>"+ myitem.title +"</p>"+
			 							"<p class='prouduct_name'>" + myitem.title +"</p>"+
					    ...
					    $('#myPagination').twbsPagination({
			                 ...
			                 /*  hideOnlyOnePage: true, */
			                  onPageClick: function (evt, page) { 
			                	  queryData(classfication,suitableAges,genderPreference,page);
				       		}
		                 });
