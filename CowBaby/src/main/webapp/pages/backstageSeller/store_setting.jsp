...
<body>
	...
	<div class="container">
		<div class="row">
			<section class="panel"> <header
				...
				style="background:#93bad1;color: #fff; ">商店基本資料</header>
			<div class="panel-body">
				<!-- action="<c:url value="SellerBackstageManageController.controller"/> -->
				<!-- 								<form class="form-horizontal" id="shopSetForm"  method="POST" enctype="multipart/form-data" action="http://localhost:8080/CowBaby/SellerBackstageManageController.controller"> -->

				<form class="form-horizontal" id="shopSetForm"
					...
					<div class="row">
						...
						<div class="form-group col-md-12" style="padding-top: 30px;">
							...
							<div class="col-md-3" style="padding-top: 35px;">
								<input type="file" name="storeBanner" id="aa"
									style="margin-bottom: 10px;"> <span class="pictip">(長寬為1024*768，大小不得超過1M)</span>
							</div>
						</div>
					</div>
				...
				<div class="dash-line col-md-12" /></div>
				<button id="qq" class="btn btn-primary pull-right"
					style="margin-top: 15px;">設定儲存</button>
			</div>
			</section>
		</div>
	</div>
	...
	<!--wrapper end--> </section> <!--main-content end--> </section> <!--containe end--> </section>
</body>
</html>
